    ...
    datasets: [
      {
        ...
        backgroundColor: (context) => {
          ...
          gradient.addColorStop(0, 'rgba(255, 138, 0, 0.5)');
    ...
    <div className="flex flex-col gap-6 w-full pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#0A0B0E] border border-white/5 rounded-2xl p-6 shadow-xl relative overflow-hidden">
          ...
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#FF8A00] opacity-5 rounded-full blur-[100px] pointer-events-none"></div>
          ...
          <div className="flex justify-between items-start mb-6 relative z-10">
            <div>
              ...
              <div className="flex items-end gap-3">
                ...
                <div className="flex items-center gap-1 text-[#FF8A00] text-sm mb-1">
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-[#0A0B0E] border border-white/5 rounded-2xl p-5 shadow-xl relative overflow-hidden group hover:border-[#FF8A00]/20 transition-colors">
            ...
            <div className="w-full h-1 bg-white/5 rounded-full mt-4 overflow-hidden">
              <div className="h-full bg-gradient-to-r from-[#FF5500] to-[#FF8A00]" style={{ width: '100%' }}></div>
            </div>
          </div>
        ...
        <div className="bg-[#0A0B0E] border border-white/5 rounded-2xl p-6 shadow-xl relative overflow-hidden">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#12141A] rounded-xl p-5 border border-white/5 relative overflow-hidden">
              <div className="absolute right-0 top-0 w-32 h-32 bg-[#FF5500] opacity-5 rounded-full blur-[50px]"></div>
              <div className="flex justify-between items-center mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-[#FF5500]/20 flex items-center justify-center text-[#FF5500] font-bold text-sm">G</div>
            ...
            {/* Matheus */}
            <div className="bg-[#12141A] rounded-xl p-5 border border-white/5 relative overflow-hidden">
              <div className="absolute right-0 top-0 w-32 h-32 bg-[#FF8A00] opacity-5 rounded-full blur-[50px]"></div>
              <div className="flex justify-between items-center mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-[#FF8A00]/20 flex items-center justify-center text-[#FF8A00] font-bold text-sm">M</div>
        ...
        <div className="bg-[#0A0B0E] border border-white/5 rounded-2xl p-6 shadow-xl flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="bg-[#12141A] rounded-xl p-4 border border-white/5">
              <span className="text-xs text-gray-500 flex items-center gap-1 mb-1"><ArrowUpRight className="w-3 h-3 text-[#FF8A00]" /> Maior Valor</span>
              <p className="text-white font-medium truncate">{highestLead?.name || 'N/A'}</p>
              <p className="text-lg font-bold text-[#FF8A00] mt-1">{highestLead ? new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(highestLead.value) : 'R$ 0,00'}</p>
            </div>
            <div className="bg-[#12141A] rounded-xl p-4 border border-white/5">
